...
[data-theme="cream"] .btn-primary,
   ...
   .search-inline{ width:100%; max-width:820px; margin:0 auto; }
    ...
    mark{
      background: color-mix(in srgb, var(--primary) 22%, #fff3b0);
      color: inherit;
      padding: 0 .14em;
      border-radius: .25em;
    ...
    /* Para hebreo/griego (NFD) evita recortes raros */
    .hebrew mark, .greek mark{ padding: 0 .18em; }
...
<body>
 ...
 <main class="container sitewrap my-3 my-lg-4">
    <section class="panel mb-3">
        <div class="panel-header">Buscador de palabras</div>
      <div class="panel-body">
        <div class="form-text mb-2">Se aceptan términos en hebreo, griego o español.</div>
        ...
        <section class="panel">
          <div class="panel-header d-flex flex-wrap justify-content-between align-items-center gap-2">
            ...
            <div id="bxResultsLoadingIndicator" class="loading-indicator" role="status" aria-live="polite" hidden>
              <span class="spinner" aria-hidden="true"></span><span>Procesando resultados por corpus...</span>
            </div>
          </div>
          <div class="panel-body">
            <div id="bxResultsLoadingStage" class="results-loading-stage" role="status" aria-live="polite" hidden>
              <span class="big-spinner" aria-hidden="true"></span><span class="fw-semibold">Cargando análisis...</span>
            </div>
            <div id="bxResultsByCorpus" class="row g-3"></div>
          </div>
        </section>
      </div>
    </div>
  ...
  <script src="./busquedax.js"></script>
  <script>
